...
class InMemoryCommunityRepository : CommunityRepository {
    ...
    override suspend fun getFeed(): List<CommunityPost> {
        ...
        val postM2 = CommunityPost(
            ...
            // Direktes Bild aus dem Artikel – wenn es nicht lädt, einfach die Bild-URL aus dem Browser kopieren und hier ersetzen
        ...
        return listOf(postM2, post2, post4, post1, post3)
    }
}
